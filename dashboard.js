...
const sections = ['home-section','workflow-section','thesis-section','submission-section','accounting-section','savings-section','habit-section','care-section','mentor-section','review-section','dashboard-section','settings-section'];
const charts = { focus:null, attendance:null, habit:null, thesis:null, wellbeing:null, submission:null, accountingTrend:null, accountingCategory:null, savingsTrend:null, savingsProgress:null };
