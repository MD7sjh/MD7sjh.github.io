/**
 * Shared date, time, formatting and metadata helpers
 * Phase-1 modularization: classic deferred scripts share the original global scope.
 * Functions: uid, pad, todayStr, nowTime, nowDateTime, parseYMD, ymd, dateFromDateTime, shiftDate, parseHM, escapeHtml, hmToMinutes, minutesBetween, formatMinutes, formatDurationHM, addMinutesToHM, bytesToKB, dayLabel, sortByTime, jsDateFrom, clamp, diffDays, startOfWeek, startOfMonth, dateSpan, isDateInRange, statsModeText, getStatsRange, todayBucketMeta, projectAreaMeta, projectStatusMeta, setInputIfIdle
 */
'use strict';
